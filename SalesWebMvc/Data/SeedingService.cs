...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //DB ja foi populado (seeded)
            }
            ...
            Seller s3 = new Seller(3, "Otavio Orange", "otavio@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seller s4 = new Seller(4, "Peter Black", "peter@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seller s5 = new Seller(5, "Poison Ivy", "poison@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seller s6 = new Seller(6, "Bruce Wayne", "wayne@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
